                                                                ...
                                                                <div class="modal-body">
                                                                    <?php 
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control"  placeholder="Please enter your phone number" name="telNumber" value="<?php echo $USER_DATA->phones_number;?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control"  placeholder="Please enter your  address" name="address" value="<?php echo $USER_DATA->address;?>">
                                                                        </div>
